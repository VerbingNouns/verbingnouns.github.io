...
about:
  ...
  links:
    - icon: calendar-check-fill
      text: Book a meeting
      href: https://outlook.office.com/bookwithme/user/86f82b4fad01481d87765bdb6586d352@newcastle.ac.uk?anonymous&ismsaljsauthenabled&ep=plink
    - icon: envelope
      text: Email me
      href: "mailto:lauren.ackerman@newcastle.ac.uk"  
...
In addition, I work on inter- language/talker differences in pitch and speech spectra, processing of gapped constructions, and the cues to phonemic identity from consonant transitions in the acoustics of singing.

## In my free time

Outside of the lab, you can find me hiking/walking, creating art and crafting.
